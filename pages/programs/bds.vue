<template>
  <div class="program-page">
    <!-- Hero Section -->
    <section class="hero-section bg-gradient-to-r from-brand-ocean to-[#0f5091] text-white py-20 md:py-32">
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          ...
          <p class="text-xl md:text-2xl mb-8 text-gray-200">
            Study dentistry at world-class universities with modern facilities, international recognition, and
          ...
          <div class="flex flex-wrap gap-4 justify-center">
            <NuxtLink to="/contact"
              class="btn-primary bg-accent-yellow text-gray-900 hover:bg-yellow-400 px-8 py-4 rounded-full font-semibold text-lg transition-all hover:scale-105 shadow-lg text-white">
              Get Started Now
            </NuxtLink>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            China offers world-class dental education with cutting-edge technology, experienced faculty, and global
            recognition
          </p>
        </div>
            ...
            <div class="ml-16">
              <ul class="space-y-2 text-gray-700">
                <li class="flex items-start">
                  ...
                  <span><strong>Full-time Clinical Practice:</strong> Independent patient treatment under
                    supervision</span>
                </li>
                <li class="flex items-start">
                  <span class="text-accent-yellow mr-2">•</span>
                ...
                <li class="flex items-start">
                  <span class="text-accent-yellow mr-2">•</span>
                  <span><strong>Hospital Internship:</strong> Comprehensive clinical experience in affiliated
                    hospitals</span>
                </li>
                <li class="flex items-start">
                  <span class="text-accent-yellow mr-2">•</span>
                  <span><strong>Licensing Preparation:</strong> Preparation for home country licensing
                    examinations</span>
                </li>
              </ul>
            </div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="mt-12 text-center">
            <div class="bg-gradient-to-r from-brand-ocean to-[#0f5091] p-8 rounded-xl text-white">
              <h3 class="text-2xl font-bold mb-4">Ready to Start Your Dental Career?</h3>
              <p class="mb-6 text-lg">Join hundreds of successful dentists who studied BDS in China with our guidance
              </p>
              <div class="flex flex-wrap gap-4 justify-center">
                <NuxtLink to="/contact"
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div class="bg-white p-8 rounded-xl shadow-md">
            ...
            <p class="text-gray-700 italic mb-4">
              ...
              the clinical exposure was exceptional. GEC team supported me throughout my journey, from admission to
              graduation."
            </p>
          ...
          <div class="bg-white p-8 rounded-xl shadow-md">
            ...
            <p class="text-gray-700 italic mb-4">
              ...
              modern techniques I learned gave me confidence. Thank you GEC for making this possible!"
            </p>
            <div class="text-accent-yellow">★★★★★</div>
          </div>
          ...
          <div class="bg-white p-8 rounded-xl shadow-md">
            ...
            <p class="text-gray-700 italic mb-4">
              ...
              GEC team was like family - always there when I needed help. Highly recommended!"
            </p>
            <div class="text-accent-yellow">★★★★★</div>
          </div>
        </div>
          ...
          <div class="space-y-4">
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 1" class="p-6 pt-0">
                <p class="text-gray-700">
                  Yes, BDS degrees from recognized Chinese universities are valid in Pakistan. The universities are
                  recognized by Pakistan Medical Commission (PMC) and WHO. After graduation, you need to clear the PMC
                  licensing examination to practice dentistry in Pakistan. Our students have successfully cleared these
                  exams and are practicing throughout Pakistan.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 2" class="p-6 pt-0">
                <p class="text-gray-700">
                  The BDS program is taught entirely in English for international students. You don't need to learn
                  Chinese to study, though basic Chinese language courses are provided to help you communicate with
                  patients during clinical practice. The textbooks, lectures, and examinations are all in English.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 3" class="p-6 pt-0">
                <p class="text-gray-700">
                  Clinical exposure is excellent in Chinese dental schools. Starting from the third year, you'll
                  practice on patients under supervision in university dental hospitals. These hospitals treat thousands
                  of patients daily, providing extensive hands-on experience in all dental specialties. In the final
                  year, you'll work almost full-time in clinics, handling various cases independently under faculty
                  supervision.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 4" class="p-6 pt-0">
                <p class="text-gray-700">
                  Living expenses in China are quite affordable. Monthly costs typically range from $200-400 depending
                  on the city and lifestyle. This includes accommodation, food, transportation, and personal expenses.
                  University dormitories are available at very reasonable rates ($50-100 per month), and food is
                  inexpensive whether you cook yourself or eat at campus cafeterias.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 5" class="p-6 pt-0">
                <p class="text-gray-700">
                  Chinese dental schools have state-of-the-art infrastructure and equipment. You'll find digital X-ray
                  systems, CAD/CAM technology, 3D dental imaging, simulation labs with phantom heads, modern
                  sterilization equipment, and advanced surgical instruments. Many facilities are newer and more
                  advanced than those in Western countries. Students get hands-on experience with the latest dental
                  technology.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 6" class="p-6 pt-0">
                <p class="text-gray-700">
                  Yes, you can pursue specialization after completing your BDS. You can either specialize in China by
                  continuing for MDS (Master of Dental Surgery) or return to your home country for specialization. Many
                  universities in China offer excellent MDS programs in various specialties like Orthodontics, Oral
                  Surgery, Prosthodontics, Periodontics, and Pediatric Dentistry.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 7" class="p-6 pt-0">
                <p class="text-gray-700">
                  China is very safe for international students. The crime rate is low, and Chinese people are generally
                  friendly and helpful toward foreigners. Universities have dedicated international student offices
                  providing 24/7 support. Campuses have security, and cities have extensive CCTV coverage. We also
                  provide ongoing support to all our students throughout their stay in China.
                </p>
              </div>
            </div>
            ...
            <div class="faq-item bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === 8" class="p-6 pt-0">
                <p class="text-gray-700">
                  GEC provides comprehensive support throughout your dental education journey. We assist with university
                  selection, application processing, visa guidance, pre-departure orientation, airport pickup,
                  accommodation arrangement, university registration, and ongoing support during your studies. Our team
                  in China is always available to help with any challenges. We also provide guidance for licensing exam
    ...
    <section class="py-20 bg-accent to-primary text-black">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-2xl mx-auto">
          Join hundreds of successful dental students who chose China for their BDS education. Get expert guidance from
