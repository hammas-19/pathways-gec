  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="relative bg-gradient-to-br from-primary via-blue-700 to-secondary text-white py-20">
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          ...
          <h1 class="text-4xl md:text-5xl font-bold mb-6">Chinese Student Visa (X1): Complete Application Guide 2025</h1>
          <div class="flex items-center gap-6 text-sm text-blue-100">
            <span>📅 Updated: January 2025</span>
            <span>⏱️ 10 min read</span>
            <span>✍️ By GEC Visa Team</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <article class="container mx-auto px-4 py-16">
      <div class="max-w-4xl mx-auto">
          ...
          <div class="grid md:grid-cols-2 gap-6 mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border-l-4 border-primary">
              ...
              <ul class="space-y-2 text-gray-700">
                ...
                <li>✓ Must apply for residence permit within 30 days of arrival</li>
                <li>✓ Valid for duration of studies</li>
              </ul>
            </div>

            <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg p-6 border-l-4 border-gray-400">
              <h3 class="text-xl font-bold text-gray-600 mb-3">X2 Visa (Short-term Study)</h3>
              <ul class="space-y-2 text-gray-600">
                <li>• For studies less than 180 days</li>
                <li>• Language courses or exchange programs</li>
                <li>• Multiple entries allowed</li>
                <li>• No residence permit needed</li>
                <li>• Not applicable for MBBS students</li>
              </ul>
            </div>
          </div>

          <div class="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
            <p class="font-semibold text-yellow-800 mb-2">📌 For MBBS Students</p>
            <p class="text-gray-700">You will apply for an <strong>X1 Visa</strong> which allows you to stay in China for the duration of your medical studies.</p>
          </div>
        </div>

        <!-- Required Documents -->
        <div class="bg-white rounded-xl shadow-md p-8 mb-8">
          <h2 class="text-3xl font-bold mb-6 text-gray-900">Required Documents for X1 Visa</h2>
          ...
          <div class="space-y-6">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• At least 2 blank visa pages</p>
                <p class="text-gray-600">• Photocopy of passport data page and any previous Chinese visas</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Print and sign the completed form</p>
                <p class="text-gray-600">• Must match passport information exactly</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Size: 48mm x 33mm</p>
                <p class="text-gray-600 mb-2">• White background, no glasses</p>
                <p class="text-gray-600">• Formal attire (no t-shirts)</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Issued by Chinese Ministry of Education</p>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Original copy required</p>
                <p class="text-gray-600">• Confirms your acceptance and program details</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Can be done at designated hospitals in Pakistan</p>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Valid for 6 months</p>
                <p class="text-gray-600">• Notarized and translated into English if needed</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Transcripts/mark sheets</p>
                <p class="text-gray-600 mb-2">• For MBBS: Intermediate/A-Level certificates</p>
                <p class="text-gray-600">• Some consulates may require notarization</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Sponsor's financial documents if applicable</p>
                <p class="text-gray-600">• Proof of ability to pay for tuition and living expenses</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-2">• Accommodation confirmation in China</p>
                <p class="text-gray-600 mb-2">• Travel insurance (recommended)</p>
                <p class="text-gray-600">• Parental consent letter (if under 18)</p>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <div class="space-y-6">
            <div class="border-l-4 border-primary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• JW202 Form (via courier)</li>
            ...
            <div class="border-l-4 border-secondary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Blood tests (HIV, hepatitis, etc.)</li>
                <li>• Chest X-ray</li>
                <li>• ECG</li>
            ...
            <div class="border-l-4 border-primary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Visit local police station or NADRA</li>
            ...
            <div class="border-l-4 border-secondary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Visit: www.visaforchina.org</li>
                <li>• Fill all sections accurately</li>
            ...
            <div class="border-l-4 border-primary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Book online or via phone</li>
            ...
            <div class="border-l-4 border-secondary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Bring all original documents + photocopies</li>
                <li>• Submit biometric data (photo, fingerprints)</li>
                <li>• Pay visa fee</li>
            ...
            <div class="border-l-4 border-primary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Normal processing: 4-5 working days</li>
            ...
            <div class="border-l-4 border-secondary pl-6">
              ...
              <ul class="text-gray-600 ml-6 space-y-1">
                <li>• Bring receipt and ID</li>
                <li>• Check visa details carefully</li>
        ...
        <!-- Important Tips -->
        <div class="bg-white rounded-xl shadow-md p-8 mb-8">
          <h2 class="text-3xl font-bold mb-6 text-gray-900">Important Tips for Success</h2>

          <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-green-50 rounded-lg p-6 border-l-4 border-green-500">
              <h4 class="font-bold text-green-700 mb-3">✅ Do This</h4>
              <ul class="space-y-2 text-gray-700">
                <li>✓ Start visa process immediately after receiving JW202</li>
                <li>✓ Double-check all documents before submission</li>
                <li>✓ Dress formally for visa appointment</li>
                <li>✓ Arrive 15-20 minutes before appointment</li>
                <li>✓ Keep photocopies of everything</li>
                <li>✓ Be honest in all information provided</li>
                <li>✓ Follow up if processing takes longer than expected</li>
              </ul>
            </div>

            <div class="bg-red-50 rounded-lg p-6 border-l-4 border-red-500">
              <h4 class="font-bold text-red-700 mb-3">❌ Avoid This</h4>
              <ul class="space-y-2 text-gray-700">
                <li>✗ Don't wait until last minute</li>
                <li>✗ Don't submit incomplete documents</li>
                <li>✗ Don't provide false information</li>
                <li>✗ Don't book flights before getting visa</li>
                <li>✗ Don't forget to check visa validity dates</li>
                <li>✗ Don't lose your JW202 form</li>
                <li>✗ Don't submit blurry or old photos</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <!-- After Arrival -->
        <div class="bg-white rounded-xl shadow-md p-8 mb-8">
          <h2 class="text-3xl font-bold mb-6 text-gray-900">After Arriving in China</h2>

          <div class="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg mb-6">
            <p class="font-semibold text-yellow-800 mb-2">⚠️ Critical: Complete Within 30 Days</p>
            <p class="text-gray-700">After arriving in China with your X1 visa, you MUST apply for a residence permit within 30 days. This is mandatory!</p>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="border-l-4 border-primary pl-6">
              ...
              <ul class="text-gray-600 ml-6 mt-2 space-y-1">
                <li>• Passport with X1 visa</li>
                <li>• JW202 form</li>
                <li>• Admission notice</li>
                <li>• Chinese medical examination results</li>
        ...
        <div class="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <div class="space-y-4">
            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: How long does the entire visa process take?</h4>
              <p class="text-gray-600">From receiving JW202 to getting visa: approximately 3-4 weeks. Start early to avoid any delays!</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: What if my visa application is rejected?</h4>
              <p class="text-gray-600">Rejections are rare for student visas with proper documentation. If rejected, you can reapply after addressing the issues. GEC's 95% success rate means rejections are very uncommon.</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: Can I apply for visa without physical examination?</h4>
              <p class="text-gray-600">No, physical examination is mandatory for X1 visa. It's a requirement from Chinese immigration authorities.</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: How much are the visa fees?</h4>
              <p class="text-gray-600">X1 visa fees vary by nationality and processing speed. Check with the Chinese Visa Application Service Center for current rates.</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: Can I travel to other countries with Chinese student visa?</h4>
              <p class="text-gray-600">Yes, but you'll need to apply for visas for those countries separately. Chinese student visa only allows entry to China.</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: What if my JW202 gets lost?</h4>
              <p class="text-gray-600">Contact your university immediately. They can issue a duplicate, but it takes time. Keep JW202 very safe!</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: Can I travel back to Pakistan during my studies?</h4>
              <p class="text-gray-600">Yes! Once you have residence permit, it allows multiple entries. You can travel home during vacations.</p>
            </div>

            <div class="border border-gray-200 rounded-lg p-6">
              <h4 class="font-bold text-gray-800 mb-2">Q: Do I need travel insurance for visa?</h4>
              <p class="text-gray-600">While not always mandatory, it's highly recommended and some visa centers may ask for it.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-primary to-secondary text-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div class="bg-white/10 backdrop-blur rounded-lg p-6 mb-6">
            <h3 class="text-xl font-bold mb-3">GEC Visa Services Include:</h3>
            <ul class="space-y-2 text-blue-50">
              <li>✓ Complete document checklist and guidance</li>
              <li>✓ JW202 coordination with universities</li>
              <li>✓ Medical examination appointment assistance</li>
              <li>✓ Visa application form review</li>
              <li>✓ Document verification before submission</li>
              <li>✓ Appointment booking assistance</li>
              <li>✓ Post-arrival residence permit guidance</li>
            </ul>
          </div>
...
useHead({
  title: 'Chinese Student Visa (X1): Complete Application Guide 2025 for Pakistani Students',
  meta: [
    { name: 'description', content: 'Step-by-step guide to applying for Chinese X1 student visa. Learn about required documents, application process, JW202 form, medical examination, and residence permit. 95% success rate with GEC guidance.' },
    { name: 'keywords', content: 'China student visa, X1 visa, Chinese visa Pakistan, JW202 form, student visa China, visa application China, study visa, residence permit China, MBBS visa China, Pakistani students visa' },
    { property: 'og:title', content: 'Chinese Student Visa (X1): Complete Application Guide 2025' },
    { property: 'og:description', content: 'Complete guide to getting your Chinese student visa with step-by-step process, required documents, and expert tips.' },
    { property: 'og:type', content: 'article' },
  ],
  link: [
    { rel: 'canonical', href: 'https://gec-pathways.com/blog/chinese-student-visa-guide' }
  ]
})
</script>
