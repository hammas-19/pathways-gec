<template>
  <section class="section bg-accent-yellow/30">
    <div class="container-custom">
      <div class="text-center mb-12">
        <div class="text-6xl mb-4">🏆</div>
        <h2 class="mb-4">Up to 100% Scholarship Available</h2>
        <p class="text-body-lg text-gray-700">For Bachelors, Masters, PhD & Diploma Programs</p>
      </div>
      ...
      <div class="text-center">
        <NuxtLink to="/scholarships" class="btn-primary">Explore All Scholarships</NuxtLink>
      </div>
    </div>
  </section>
</template>
